...
class Deshadower(object):
    ...
    def setup_model(self):
        ...
        with tf.compat.v1.variable_scope(tf.compat.v1.get_variable_scope()):
            ...
            # build the model
            self.shadow_free_image, predicted_mask = build_aggasatt_joint(self.input, self.channel,
            ...
            d_loss = (tf.reduce_mean(
                -(tf.compat.v1.log(predict_real + EPS) + tf.compat.v1.log(1 - predict_fake + EPS)))) * 0.5
